                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent uppercase ${
                        referralValid === true ? 'border-green-400 bg-green-50' : 
                        referralValid === false ? 'border-red-400 bg-red-50' : 
                        'border-gray-300'
                      }`}
                      placeholder="e.g., JOES-1234"
                  ...
                  {referralValid === true && referralInfo && (
                    <p className="text-sm text-green-600 mt-1">
                      ✨ {referralInfo.discount} Referred by {referralInfo.referrer_name}
                    </p>
                  )}
                  {referralValid === false && formData.referral_code.length >= 4 && (
