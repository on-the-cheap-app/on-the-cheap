...
async def search_restaurants(
    ...
    vendor_type: Optional[str] = Query(None, regex="^(all|permanent|mobile|bar|popup|other)$"),  # Filter for venue type
...
async def create_owner_restaurant(request: CreateRestaurantRequest, current_user: dict = Depends(get_current_user)):
    ...
    try:
        ...
        restaurant = {
            ...
            "vendor_type": request.vendor_type or "permanent",
            "is_mobile_vendor": request.vendor_type == "mobile",
            "is_popup": request.vendor_type == "popup",
            "rating": None,
            "price_level": 2,
            "specials": [],
            "is_verified": False,
